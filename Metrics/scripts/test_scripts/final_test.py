...
mp_drawing = mp.solutions.drawing_utils  # Drawing utility for skeleton
    ...
    while True:
        ...
        if pose_results.pose_landmarks:
            ...
            try:
                ...
                if left_elbow_angle < rep_threshold and right_elbow_angle < rep_threshold:  # Example condition for a rep
                    completed_reps += 1
        ...
        # Display the repetitions completed on the video frame
        cv2.putText(frame, f"Completed Reps: {completed_reps}", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
